...
import RecoveryStrategyStandalone from '../recovery_strategy/RecoveryStrategyStandalone.jsx';
...
import BCMStandalone from '../../modules/bcm/BCMStandalone.jsx';
import OrganizationBCMPlan from '../../modules/bcm/OrganizationBCMPlan.jsx';
import DepartmentalBCMPlan from '../../modules/bcm/DepartmentalBCMPlan.jsx';
...
const getUserInfoFromToken = () => {
  ...
  try {
    ...
    const roles = decoded.roles || [];
    const primaryRole = roles.length > 0 ? roles[0] : '';
    const organizationId = localStorage.getItem('organizationId') || decoded.organization_id || '';
    ...
    <AuthProvider>
      <Router>
        <Routes>
          ...
          {/* Direct access routes (bypass login) */}
          <Route path="/recovery-strategy-direct" element={<RecoveryStrategyDashboard />} />
          <Route path="/recovery-strategy-standalone" element={<RecoveryStrategyStandalone />} />
          <Route path="/recovery" element={<RecoveryStrategyStandalone />} />
          <Route path="/rs" element={<RecoveryStrategyStandalone />} />
          <Route path="/bcm-direct" element={<BCMDashboard />} />
          <Route path="/crisis-management-direct" element={<CrisisManagement />} />
          
          {/* ✅ FIXED BCM Routes - Correct paths matching your navigation */}
          <Route path="/bcm" element={<BCMDashboard />} />
          <Route path="/bcm-standalone" element={<BCMStandalone />} />
          <Route path="/bcm/organization-plan" element={<OrganizationBCMPlan />} />
          <Route path="/bcm/department-plan/:departmentId" element={<DepartmentalBCMPlan />} />
