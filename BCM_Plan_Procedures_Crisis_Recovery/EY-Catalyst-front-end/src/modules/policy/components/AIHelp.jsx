    ...
    <div className="app-container">
      ...
      <nav className="navbar">
        ...
        <div className="navbar-nav">
          ...
          <Link to="/policy/wizard" className="nav-link">
            Wizard
          </Link>
          <Link to="/policy/progress" className="nav-link">
            Progress
          </Link>
        </div>
      </nav>
      ...
      <div className="container">
        <div className="text-center mb-4">
          ...
          <p className="text-gray-300">
            Get intelligent recommendations and guidance for your business
            continuity policy development
          </p>
        </div>
              ...
              >
                {messages.length === 0 && (
                  <div className="text-center text-gray-400 mt-8">
                    ...
                    <p>
                      Hello! I'm your BCM AI Assistant. I can help you with:
                    </p>
                    ...
                    <p className="mt-4">
                      Ask me anything about business continuity management!
                    </p>
                  </div>
                )}
                  ...
                  >
                    <div
                      ...
                      style={{
                        ...
                        borderRadius: "50%",
                        background:
                          message.sender === "user" ? "#ffcc00" : "#333",
                        display: "flex",
                        alignItems: "center",
                    ...
                    <div
                      ...
                      style={{
                        background:
                          message.sender === "user" ? "#ffcc00" : "#1a1a1a",
            ...
            <div className="card">
              ...
              <div className="space-y-2 text-sm">
                {Object.entries(ISO22301_CLAUSES).map(([clause, data]) => (
                  <div
                    key={clause}
                    className="border-l-2 border-yellow-400 pl-2"
                  >
