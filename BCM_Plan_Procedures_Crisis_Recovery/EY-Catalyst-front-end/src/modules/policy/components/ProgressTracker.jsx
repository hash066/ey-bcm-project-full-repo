...
const ProgressTracker = () => {
    ...
    WIZARD_STEPS.forEach((step) => {
      ...
      step.fields.forEach((field) => {
        ...
        if (
          ...
          wizardData[field.name].toString().trim() !== ""
        ) {
          completedFields++;
          stepCompleted++;
        }
      ...
      stepProgress[step.id] = {
        ...
        total: stepTotal,
        percentage:
          stepTotal > 0 ? Math.round((stepCompleted / stepTotal) * 100) : 0,
      };
    });
  ...
  const getComplianceScore = () => {
    ...
    const completedRequired = requiredFields.filter(
      (field) => wizardData[field] && wizardData[field].toString().trim() !== ""
    ).length;
    ...
    <div className="app-container">
      ...
      <nav className="navbar">
        ...
        <div className="navbar-nav">
          ...
          <Link to="/policy/ai" className="nav-link">
            AI Help
          </Link>
        </div>
      </nav>
      ...
      <div className="container">
        <div className="text-center mb-4">
          ...
          <p className="text-gray-300">
            Track your business continuity policy creation progress and
            milestones
          </p>
        </div>
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    <div>
                      ...
                      {completedPolicy.organizationName}
                    </div>
                    <div>
                      <strong>Template:</strong> {completedPolicy.template}
                    </div>
                    <div>
                      <strong>Completed:</strong>{" "}
                      {formatDate(completedPolicy.completedAt)}
                    </div>
                    <div>
                      <strong>Effective Date:</strong>{" "}
                      {formatDate(completedPolicy.effectiveDate)}
                    </div>
                  </div>
                </div>
              ) : (
                ...
                {progressStats.overall >= 25 && progressStats.overall < 50 && (
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-400">
                        Set regulatory and standard requirements
                      </div>
                    </div>
                  </div>
                )}
                ...
                {progressStats.overall === 100 && !completedPolicy && (
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-400">
                        Complete the wizard to generate your policy
                      </div>
                    </div>
                  </div>
                )}
