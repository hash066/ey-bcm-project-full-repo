...
# UNIFIED: Use unified RBAC system constants
from app.models.unified_rbac import ROLE_HIERARCHY

# Unified role constants - use the same as unified system
...
ROLE_ORGANIZATION_HEAD = ROLE_DEPARTMENT_HEAD  # Map to department_head in unified
...
class User(Base):
    ...
    __tablename__ = "gap_assessment_users"
...
class ApprovalRequest(Base):
    ...
    submitted_by = Column(Integer, ForeignKey("gap_assessment_users.id"), nullable=False)
...
class ApprovalStep(Base):
    ...
    approver_id = Column(Integer, ForeignKey("gap_assessment_users.id"), nullable=True)  # Can be None for auto-approval
...
class Framework(Base):
    ...
    submitted_by = Column(Integer, ForeignKey("gap_assessment_users.id"), nullable=False)
    approved_by = Column(Integer, ForeignKey("gap_assessment_users.id"), nullable=True)
