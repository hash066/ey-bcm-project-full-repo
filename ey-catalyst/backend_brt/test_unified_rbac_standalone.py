#!/usr/bin/env python3
"""
Standalone Test for Unified RBAC System
Tests the unified RBAC without importing conflicting models.
"""
...
# Import only the unified RBAC components we need
...
def test_unified_rbac_standalone():
    """Test the unified RBAC system in isolation."""
    print("🧪 Testing Unified RBAC System (Standalone)")
    print("=" * 55)
...
if __name__ == "__main__":
    success = test_unified_rbac_standalone()
