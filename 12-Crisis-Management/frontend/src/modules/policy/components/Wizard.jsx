...
const Wizard = () => {
  ...
  useEffect(() => {
    const templateSteps =
      TEMPLATE_SPECIFIC_STEPS[selectedTemplate] || WIZARD_STEPS;
    ...
    POLICY_TEMPLATES.custom.isCustom ? (
      <div className="mt-4">
        <div className="form-group">
          <label className="form-label">
            Enter custom compliance requirements
          </label>
          <textarea
            ...
            onChange={(e) =>
              handleInputChange("customCompliance", e.target.value)
            }
          />
        </div>
      </div>
      ...
      <div className="container">
                ...
                <div key={key} className="col">
                  <div
                    className={`card cursor-pointer ${
                      selectedTemplate === key ? "border-yellow-400" : ""
                    }`}
        ...
        <div className="card">
          <div className="card-header">
            <div className="flex items-center justify-between">
              ...
              {formData.isoCompliance && renderTooltip(`${currentStep}.1`)}
            </div>
          </div>
        ...
        <div className="flex justify-between items-center mt-4">
          <button
            ...
            className={
              currentStep === 1 ? "btn-secondary opacity-50" : "btn-secondary"
            }
          >
            ...
            <button
              onClick={() => {
                ...
                localStorage.setItem(
                  "bcm_completed_policy",
                  JSON.stringify(completedPolicy)
                );
