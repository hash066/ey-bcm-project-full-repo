...
8. [Module-Wise Architecture](#module-wise-architecture)
...
┌─────────────────────────────────────────────────────────────┐
│                    Presentation Layer                        │
│  (React/Vue Frontend, Mobile Apps, Admin Portal)            │
└──────────────────────┬──────────────────────────────────────┘
                       │
┌──────────────────────▼──────────────────────────────────────┐
│                    Application Layer                         │
│  (REST APIs, GraphQL, Microservices, AI Services)           │
└──────────────────────┬──────────────────────────────────────┘
                       │
┌──────────────────────▼──────────────────────────────────────┐
│                      Data Layer                              │
...
![component_diagram](diagrams/images/component_diagram.png)
...
![low-level_design_lld](diagrams/images/low-level_design_lld.png)
...
![sequence_diagram_login_flow](diagrams/images/sequence_diagram_login_flow.png)

### Module 2: Business Impact Analysis (BIA) Service

#### Architecture Flowchart

![module_2_business_impact_analysis_bia_service](diagrams/images/module_2_business_impact_analysis_bia_service.png)
...
![sequence_diagram_bia_creation_flow](diagrams/images/sequence_diagram_bia_creation_flow.png)

### Module 3: Risk Assessment (RA) Service

#### Architecture Flowchart

![module_3_risk_assessment_ra_service](diagrams/images/module_3_risk_assessment_ra_service.png)
...
- **AIRepository:** AI model integration

#### Sequence Diagram: Risk Assessment Flow

![sequence_diagram_risk_assessment_flow](diagrams/images/sequence_diagram_risk_assessment_flow.png)

### Module 4: Dashboard Service

#### Architecture

![module_4_dashboard_service](diagrams/images/module_4_dashboard_service.png)
...
![module_5_export_service](diagrams/images/module_5_export_service.png)
...
![entity_relationship_diagram_erd](diagrams/images/entity_relationship_diagram_erd.png)
...
![data_flow_diagrams](diagrams/images/data_flow_diagrams.png)

### Risk Assessment Data Flow

![risk_assessment_data_flow](diagrams/images/risk_assessment_data_flow.png)

### BIA Assessment Data Flow

![bia_assessment_data_flow](diagrams/images/bia_assessment_data_flow.png)

### Export Data Flow

![export_data_flow](diagrams/images/export_data_flow.png)
...
![deployment_architecture](diagrams/images/deployment_architecture.png)

### Deployment Diagram

![deployment_diagram](diagrams/images/deployment_diagram.png)
...
![security_architecture](diagrams/images/security_architecture.png)

### Authentication & Authorization Flow

![authentication_authorization_flow](diagrams/images/authentication_authorization_flow.png)

### Data Encryption Flow

![data_encryption_flow](diagrams/images/data_encryption_flow.png)
...
![module-wise_architecture](diagrams/images/module-wise_architecture.png)
...
![integration_architecture](diagrams/images/integration_architecture.png)
...
![operational_architecture](diagrams/images/operational_architecture.png)

### Backup & Recovery

![backup_recovery](diagrams/images/backup_recovery.png)
