...
const ImpactScale = () => {
  ...
  // Use shared impact matrix context for real-time sync
  const {
    organizationMatrix,
  ...
  // State for matrix (local edits, synced with context)
  ...
  // Local state for impact types and levels (synced with context)
