...
if __name__ == "__main__":
    print(f"Starting {settings.APP_NAME} API server on port 8002...")
    print(f"Visit http://localhost:8002/docs for API documentation")
    ...
    print("Login Admin RBAC module integrated")
