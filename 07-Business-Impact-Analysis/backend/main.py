...
if __name__ == "__main__":
    print(f"Starting {settings.APP_NAME} API server on port 8007...")
    print(f"Visit http://localhost:8007/docs for API documentation")
    ...
    print("Business Impact Analysis module integrated")
