...
class SiteDetailsInput(BaseModel):
    address: str = ""
    occupancyNature: str = ""
    buildingConstruction: str = ""
    otherOccupancies: str = ""
    totalFloors: str = ""
    floorCommunication: str = ""
    totalFloorArea: str = ""
    maxUndividedArea: str = ""
    floorsOccupied: str = ""
    buildingAge: str = ""
    stabilityCertificate: str = ""
    fireNOC: str = ""
    peopleFloorWise: str = ""
    maxVisitors: str = ""
    operationalHours: str = ""
    powerBackupDetails: str = ""
    storeRoomUpkeep: str = ""
    floorCovering: str = ""
    falseCeiling: str = ""
    hvacSystem: str = ""
    buildingPerimeter: str = ""
