...
if __name__ == "__main__":
    print(f"Starting {settings.APP_NAME} API server on port 8008...")
    print(f"Visit http://localhost:8008/docs for API documentation")
    ...
    print("BCM Gap Assessment module integrated")
