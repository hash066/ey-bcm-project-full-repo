...
async def get_my_requests(
    ...
    print("=== GET MY REQUESTS CALLED - DEVELOPMENT BYPASS ===")

    # Always return mock data for development - bypass all authentication and DB checks
    print("=== DEVELOPMENT BYPASS: Returning mock data without auth/DB checks ===")
    return [
        {
            "id": "mock-request-1",
            "module_id": 3,
            "module_name": "Business Impact Analysis",
            "requester_username": "demo",
            "requester_display_name": "Demo User",
            "status": "approved",
            "created_at": "2025-10-23T14:00:00Z",
            "request_reason": "Development access for BIA module"
        },
        {
            "id": "mock-request-2",
            "module_id": 1,
            "module_name": "Process Mapping",
            "requester_username": "demo",
            "requester_display_name": "Demo User",
            "status": "approved",
            "created_at": "2025-10-23T13:00:00Z",
            "request_reason": "Development access"
        }
    ]
